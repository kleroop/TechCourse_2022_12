...
ClickCatchOverlay::ClickCatchOverlay(QWidget *parent, bool blurred) : QWidget(parent->window()), ui(new Ui::ClickCatchOverlay) {
    ui->setupUi(this);
    this->show();
    ...
    if(blurred){
        ui->button->setStyleSheet(ui->button->styleSheet() + "background-color: rgba(77, 75, 75, 0.4);");
    }
