...
public:
    Category(int id, std::string title, ICategory* parent = nullptr):ICategory(id, title, parent)
    {
...
public:
    SubCategory(int id, std::string title, ICategory* parent = nullptr):ICategory(id, title, parent)
    {
...
public:
    Team(int id, std::string title, ICategory* parent = nullptr):ICategory(id, title, parent)
    {
